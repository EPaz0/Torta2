class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        // Create enemies from map objects
        this.map.getObjectLayer('Enemy').objects.forEach((enemyData) => {
            const enemy = this.physics.add.sprite(enemyData.x, enemyData.y, 'characterstilemap_sheet', 0);
        ...
        // Add collider for enemies and ground layer
        ...
        this.physics.add.overlap(my.sprite.player, this.enemyGroup, this.playerHitWater, null, this);
    
        // Create a timed event for enemy jumping
        this.time.addEvent({
            delay: 2000, // 2000 milliseconds = 2 seconds
            callback: this.enemyJump,
            callbackScope: this,
            loop: true
        });
    ...
    enemyJump() {
        this.enemyGroup.children.iterate(function (enemy) {
            enemy.setVelocityY(-500); // Adjust the jump height by changing the velocity value
        });
    }
